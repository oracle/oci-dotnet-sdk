...
namespace Oci.AnnouncementsService
{
    ...
    public class ServiceClient : RegionalClientBase
    {
        ...
        /// <example>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/announcementsservice/ListServices.cs.html">here</a> to see an example of how to use ListServices API.</example>
