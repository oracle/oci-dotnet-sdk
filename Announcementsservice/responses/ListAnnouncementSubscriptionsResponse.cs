...
{
    public class ListAnnouncementSubscriptionsResponse : Oci.Common.IOciResponse
    {
        ...
        public AnnouncementSubscriptionCollection AnnouncementSubscriptionCollection { get; set; }
