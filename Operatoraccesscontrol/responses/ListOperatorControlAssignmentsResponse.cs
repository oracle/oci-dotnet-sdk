...
{
    public class ListOperatorControlAssignmentsResponse : Oci.Common.IOciResponse
    {
        ...
        public OperatorControlAssignmentCollection OperatorControlAssignmentCollection { get; set; }
