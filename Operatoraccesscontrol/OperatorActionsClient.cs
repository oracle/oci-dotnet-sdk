...
namespace Oci.OperatoraccesscontrolService
{
    ...
    public class OperatorActionsClient : RegionalClientBase
    {
        ...
        public async Task<GetOperatorActionResponse> GetOperatorAction(GetOperatorActionRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ListOperatorActionsResponse> ListOperatorActions(ListOperatorActionsRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
