...
{
    /// <summary>
    /// Contains collection of helper methods to produce Oci.Common.Waiters for different resources of AccessRequests.
    /// </summary>
    public class AccessRequestsWaiters
    {
        private readonly AccessRequestsClient client;

        public  AccessRequestsWaiters(AccessRequestsClient client)
        {
            this.client = client;
        }
