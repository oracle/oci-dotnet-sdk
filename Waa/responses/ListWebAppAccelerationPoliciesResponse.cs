...
{
    public class ListWebAppAccelerationPoliciesResponse : Oci.Common.IOciResponse
    {
        ...
        public WebAppAccelerationPolicyCollection WebAppAccelerationPolicyCollection { get; set; }
