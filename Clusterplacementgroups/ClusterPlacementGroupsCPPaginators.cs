...
namespace Oci.ClusterplacementgroupsService
{
    ...
    public class ClusterPlacementGroupsCPPaginators
    {
        ...
        public ClusterPlacementGroupsCPPaginators(ClusterPlacementGroupsCPClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListClusterPlacementGroups operation. This enumerable
        ...
        public IEnumerable<ListClusterPlacementGroupsResponse> ListClusterPlacementGroupsResponseEnumerator(ListClusterPlacementGroupsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListClusterPlacementGroupsRequest, ListClusterPlacementGroupsResponse>(
                ...
                request => client.ListClusterPlacementGroups(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the ClusterPlacementGroupSummary objects
        /// contained in responses from the ListClusterPlacementGroups operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ClusterPlacementGroupSummary> ListClusterPlacementGroupsRecordEnumerator(ListClusterPlacementGroupsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListClusterPlacementGroupsRequest, ListClusterPlacementGroupsResponse, ClusterPlacementGroupSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListClusterPlacementGroups(request, retryConfiguration, cancellationToken),
                response => response.ClusterPlacementGroupCollection.Items
            );
        }
