...
{
    public class ListPackagesInstalledOnManagedInstanceResponse : Oci.Common.IOciResponse
    {
        ...
        public System.Collections.Generic.List<InstalledPackageSummary> Items { get; set; }
