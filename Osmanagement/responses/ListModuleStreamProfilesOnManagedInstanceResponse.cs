...
{
    public class ListModuleStreamProfilesOnManagedInstanceResponse : Oci.Common.IOciResponse
    {
        ...
        public System.Collections.Generic.List<ModuleStreamProfileOnManagedInstanceSummary> Items { get; set; }
