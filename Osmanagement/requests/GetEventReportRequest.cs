...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/osmanagement/GetEventReport.cs.html">here</a> to see an example of how to use GetEventReport request.
    /// </example>
    public class GetEventReportRequest : Oci.Common.IOciRequest
    {
