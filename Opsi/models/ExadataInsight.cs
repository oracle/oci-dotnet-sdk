...
namespace Oci.OpsiService.Models
{
    ...
    public class ExadataInsight 
    {
        ...
        public System.Nullable<bool> IsVirtualizedExadata { get; set; }
    ...
    public class ExadataInsightModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(ExadataInsight);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(ExadataInsight);
            ...
            {
                logger.Warn($"The type {discriminator} is not present under ExadataInsight! Returning null value.");
            }
            return obj;
        }
    }
