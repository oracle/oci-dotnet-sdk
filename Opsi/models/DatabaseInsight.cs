...
namespace Oci.OpsiService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(DatabaseInsightModelConverter))]
    ...
    public class DatabaseInsightModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(DatabaseInsight);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(DatabaseInsight);
            ...
            switch (discriminator)
            {
                ...
                case "EXTERNAL_MYSQL_DATABASE_SYSTEM":
                    obj = new ExternalMysqlDatabaseInsight();
                    break;
                case "AUTONOMOUS_DATABASE":
                    obj = new AutonomousDatabaseInsight();
                    break;
                case "MDS_MYSQL_DATABASE_SYSTEM":
                    obj = new MdsMySqlDatabaseInsight();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under DatabaseInsight! Returning null value.");
            }
            return obj;
        }
    }
