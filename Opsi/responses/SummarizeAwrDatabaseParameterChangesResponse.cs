...
{
    public class SummarizeAwrDatabaseParameterChangesResponse : Oci.Common.IOciResponse
    {
        ...
        public AwrDatabaseParameterChangeCollection AwrDatabaseParameterChangeCollection { get; set; }
