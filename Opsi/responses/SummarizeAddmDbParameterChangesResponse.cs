...
{
    public class SummarizeAddmDbParameterChangesResponse : Oci.Common.IOciResponse
    {
        ...
        public AddmDbParameterChangeAggregationCollection AddmDbParameterChangeAggregationCollection { get; set; }
