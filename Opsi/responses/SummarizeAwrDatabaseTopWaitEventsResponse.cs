...
{
    public class SummarizeAwrDatabaseTopWaitEventsResponse : Oci.Common.IOciResponse
    {
        ...
        public AwrDatabaseTopWaitEventCollection AwrDatabaseTopWaitEventCollection { get; set; }
