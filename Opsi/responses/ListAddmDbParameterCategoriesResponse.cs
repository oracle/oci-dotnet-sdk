...
{
    public class ListAddmDbParameterCategoriesResponse : Oci.Common.IOciResponse
    {
        ...
        public AddmDbParameterCategoryCollection AddmDbParameterCategoryCollection { get; set; }
