...
{
    public class SummarizeAddmDbFindingsResponse : Oci.Common.IOciResponse
    {
        ...
        public AddmDbFindingAggregationCollection AddmDbFindingAggregationCollection { get; set; }
