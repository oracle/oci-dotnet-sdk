...
{
    public class SummarizeAwrSourcesSummariesResponse : Oci.Common.IOciResponse
    {
        ...
        public SummarizeAwrSourcesSummariesCollection SummarizeAwrSourcesSummariesCollection { get; set; }
