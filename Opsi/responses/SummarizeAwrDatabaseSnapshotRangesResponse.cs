...
{
    public class SummarizeAwrDatabaseSnapshotRangesResponse : Oci.Common.IOciResponse
    {
        ...
        public AwrDatabaseSnapshotRangeCollection AwrDatabaseSnapshotRangeCollection { get; set; }
