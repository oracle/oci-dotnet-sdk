...
{
    public class IngestHostConfigurationResponse : Oci.Common.IOciResponse
    {
        ...
        public IngestHostConfigurationResponseDetails IngestHostConfigurationResponseDetails { get; set; }
