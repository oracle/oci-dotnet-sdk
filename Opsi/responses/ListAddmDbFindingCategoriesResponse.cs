...
{
    public class ListAddmDbFindingCategoriesResponse : Oci.Common.IOciResponse
    {
        ...
        public AddmDbFindingCategoryCollection AddmDbFindingCategoryCollection { get; set; }
