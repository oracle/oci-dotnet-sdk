...
{
    public class SummarizeAwrDatabaseParametersResponse : Oci.Common.IOciResponse
    {
        ...
        public AwrDatabaseParameterCollection AwrDatabaseParameterCollection { get; set; }
