...
{
    public class SummarizeAwrDatabaseWaitEventsResponse : Oci.Common.IOciResponse
    {
        ...
        public AwrDatabaseWaitEventCollection AwrDatabaseWaitEventCollection { get; set; }
