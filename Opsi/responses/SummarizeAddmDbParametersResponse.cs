...
{
    public class SummarizeAddmDbParametersResponse : Oci.Common.IOciResponse
    {
        ...
        public AddmDbParameterAggregationCollection AddmDbParameterAggregationCollection { get; set; }
