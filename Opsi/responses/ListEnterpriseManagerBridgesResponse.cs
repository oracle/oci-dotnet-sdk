...
{
    public class ListEnterpriseManagerBridgesResponse : Oci.Common.IOciResponse
    {
        ...
        public EnterpriseManagerBridgeCollection EnterpriseManagerBridgeCollection { get; set; }
