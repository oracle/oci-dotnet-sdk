...
{
    public class ListImportableAgentEntitiesResponse : Oci.Common.IOciResponse
    {
        ...
        public ImportableAgentEntitySummaryCollection ImportableAgentEntitySummaryCollection { get; set; }
