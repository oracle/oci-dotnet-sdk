...
{
    public class SummarizeAddmDbRecommendationsResponse : Oci.Common.IOciResponse
    {
        ...
        public AddmDbRecommendationAggregationCollection AddmDbRecommendationAggregationCollection { get; set; }
