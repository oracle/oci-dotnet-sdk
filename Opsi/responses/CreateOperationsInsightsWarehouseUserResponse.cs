...
{
    public class CreateOperationsInsightsWarehouseUserResponse : Oci.Common.IOciResponse
    {
        ...
        public OperationsInsightsWarehouseUser OperationsInsightsWarehouseUser { get; set; }
