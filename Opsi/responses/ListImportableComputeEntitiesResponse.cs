...
{
    public class ListImportableComputeEntitiesResponse : Oci.Common.IOciResponse
    {
        ...
        public ImportableComputeEntitySummaryCollection ImportableComputeEntitySummaryCollection { get; set; }
