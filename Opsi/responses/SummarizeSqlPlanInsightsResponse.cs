...
{
    public class SummarizeSqlPlanInsightsResponse : Oci.Common.IOciResponse
    {
        ...
        public SqlPlanInsightAggregationCollection SqlPlanInsightAggregationCollection { get; set; }
