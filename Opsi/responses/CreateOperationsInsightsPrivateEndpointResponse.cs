...
{
    public class CreateOperationsInsightsPrivateEndpointResponse : Oci.Common.IOciResponse
    {
        ...
        public OperationsInsightsPrivateEndpoint OperationsInsightsPrivateEndpoint { get; set; }
