...
{
    public class ListAddmDbFindingsTimeSeriesResponse : Oci.Common.IOciResponse
    {
        ...
        public AddmDbFindingsTimeSeriesCollection AddmDbFindingsTimeSeriesCollection { get; set; }
