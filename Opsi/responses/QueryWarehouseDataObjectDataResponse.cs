...
{
    public class QueryWarehouseDataObjectDataResponse : Oci.Common.IOciResponse
    {
        ...
        public QueryDataObjectResultSetRowsCollection QueryDataObjectResultSetRowsCollection { get; set; }
