...
{
    public class ListConsumerGroupPrivilegesResponse : Oci.Common.IOciResponse
    {
        ...
        public ConsumerGroupPrivilegeCollection ConsumerGroupPrivilegeCollection { get; set; }
