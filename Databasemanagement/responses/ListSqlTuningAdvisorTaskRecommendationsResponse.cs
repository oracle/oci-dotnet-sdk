...
{
    public class ListSqlTuningAdvisorTaskRecommendationsResponse : Oci.Common.IOciResponse
    {
        ...
        public SqlTuningAdvisorTaskRecommendationCollection SqlTuningAdvisorTaskRecommendationCollection { get; set; }
