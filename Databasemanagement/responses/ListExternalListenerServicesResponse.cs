...
{
    public class ListExternalListenerServicesResponse : Oci.Common.IOciResponse
    {
        ...
        public ExternalListenerServiceCollection ExternalListenerServiceCollection { get; set; }
