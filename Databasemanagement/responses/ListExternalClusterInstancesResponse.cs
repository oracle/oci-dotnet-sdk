...
{
    public class ListExternalClusterInstancesResponse : Oci.Common.IOciResponse
    {
        ...
        public ExternalClusterInstanceCollection ExternalClusterInstanceCollection { get; set; }
