...
{
    public class ListSqlTuningAdvisorTaskFindingsResponse : Oci.Common.IOciResponse
    {
        ...
        public SqlTuningAdvisorTaskFindingCollection SqlTuningAdvisorTaskFindingCollection { get; set; }
