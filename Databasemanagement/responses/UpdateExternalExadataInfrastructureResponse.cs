...
{
    public class UpdateExternalExadataInfrastructureResponse : Oci.Common.IOciResponse
    {
        ...
        public ExternalExadataInfrastructure ExternalExadataInfrastructure { get; set; }
