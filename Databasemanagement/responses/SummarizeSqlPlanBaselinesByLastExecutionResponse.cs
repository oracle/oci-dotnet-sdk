...
{
    public class SummarizeSqlPlanBaselinesByLastExecutionResponse : Oci.Common.IOciResponse
    {
        ...
        public SqlPlanBaselineAggregationCollection SqlPlanBaselineAggregationCollection { get; set; }
