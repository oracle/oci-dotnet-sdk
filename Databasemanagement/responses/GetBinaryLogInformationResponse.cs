...
{
    public class GetBinaryLogInformationResponse : Oci.Common.OciResponse
    {
        ...
        public ManagedMySqlDatabaseBinaryLogInformation ManagedMySqlDatabaseBinaryLogInformation { get; set; }
