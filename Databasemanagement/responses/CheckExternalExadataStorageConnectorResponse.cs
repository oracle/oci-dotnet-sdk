...
{
    public class CheckExternalExadataStorageConnectorResponse : Oci.Common.IOciResponse
    {
        ...
        public ExternalExadataStorageConnectorStatus ExternalExadataStorageConnectorStatus { get; set; }
