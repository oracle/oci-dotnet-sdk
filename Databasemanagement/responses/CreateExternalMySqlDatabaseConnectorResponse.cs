...
{
    public class CreateExternalMySqlDatabaseConnectorResponse : Oci.Common.OciResponse
    {
        ...
        public ExternalMySqlDatabaseConnector ExternalMySqlDatabaseConnector { get; set; }
