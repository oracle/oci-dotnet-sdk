...
{
    public class SummarizeManagedMySqlDatabaseAvailabilityMetricsResponse : Oci.Common.IOciResponse
    {
        ...
        public MetricsAggregationRangeCollection MetricsAggregationRangeCollection { get; set; }
