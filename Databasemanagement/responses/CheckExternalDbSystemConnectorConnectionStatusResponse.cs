...
{
    public class CheckExternalDbSystemConnectorConnectionStatusResponse : Oci.Common.IOciResponse
    {
        ...
        public ExternalDbSystemConnector ExternalDbSystemConnector { get; set; }
