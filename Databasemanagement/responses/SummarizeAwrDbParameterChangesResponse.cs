...
{
    public class SummarizeAwrDbParameterChangesResponse : Oci.Common.IOciResponse
    {
        ...
        public AwrDbParameterChangeCollection AwrDbParameterChangeCollection { get; set; }
