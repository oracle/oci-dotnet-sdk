...
{
    public class ListExternalDbSystemConnectorsResponse : Oci.Common.IOciResponse
    {
        ...
        public ExternalDbSystemConnectorCollection ExternalDbSystemConnectorCollection { get; set; }
