...
{
    public class ListDbManagementPrivateEndpointsResponse : Oci.Common.IOciResponse
    {
        ...
        public DbManagementPrivateEndpointCollection DbManagementPrivateEndpointCollection { get; set; }
