...
{
    public class UpdateExternalExadataStorageConnectorResponse : Oci.Common.IOciResponse
    {
        ...
        public ExternalExadataStorageConnector ExternalExadataStorageConnector { get; set; }
