...
{
    public class UpdateExternalExadataStorageServerResponse : Oci.Common.IOciResponse
    {
        ...
        public ExternalExadataStorageServer ExternalExadataStorageServer { get; set; }
