...
{
    public class ListExternalDbSystemDiscoveriesResponse : Oci.Common.IOciResponse
    {
        ...
        public ExternalDbSystemDiscoveryCollection ExternalDbSystemDiscoveryCollection { get; set; }
