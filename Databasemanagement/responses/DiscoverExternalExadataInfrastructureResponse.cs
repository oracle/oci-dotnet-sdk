...
{
    public class DiscoverExternalExadataInfrastructureResponse : Oci.Common.IOciResponse
    {
        ...
        public ExternalExadataInfrastructureDiscovery ExternalExadataInfrastructureDiscovery { get; set; }
