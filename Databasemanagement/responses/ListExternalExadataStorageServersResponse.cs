...
{
    public class ListExternalExadataStorageServersResponse : Oci.Common.IOciResponse
    {
        ...
        public ExternalExadataStorageServerCollection ExternalExadataStorageServerCollection { get; set; }
