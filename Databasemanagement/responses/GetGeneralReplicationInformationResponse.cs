...
{
    public class GetGeneralReplicationInformationResponse : Oci.Common.OciResponse
    {
        ...
        public ManagedMySqlDatabaseGeneralReplicationInformation ManagedMySqlDatabaseGeneralReplicationInformation { get; set; }
