...
{
    public class ListExternalExadataInfrastructuresResponse : Oci.Common.IOciResponse
    {
        ...
        public ExternalExadataInfrastructureCollection ExternalExadataInfrastructureCollection { get; set; }
