...
{
    public class ListExternalExadataStorageConnectorsResponse : Oci.Common.IOciResponse
    {
        ...
        public ExternalExadataStorageConnectorCollection ExternalExadataStorageConnectorCollection { get; set; }
