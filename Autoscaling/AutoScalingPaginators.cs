...
namespace Oci.AutoscalingService
{
    ...
    {
        private readonly AutoScalingClient client;

        public AutoScalingPaginators(AutoScalingClient client)
        {
            this.client = client;
        }
        ...
        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListAutoScalingPolicies operation. This enumerable
        /// will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ListAutoScalingPoliciesResponse> ListAutoScalingPoliciesResponseEnumerator(ListAutoScalingPoliciesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListAutoScalingPoliciesRequest, ListAutoScalingPoliciesResponse>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
        ...
        /// <summary>
        /// Creates a new enumerable which will iterate over the AutoScalingPolicySummary objects
        /// contained in responses from the ListAutoScalingPolicies operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<AutoScalingPolicySummary> ListAutoScalingPoliciesRecordEnumerator(ListAutoScalingPoliciesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListAutoScalingPoliciesRequest, ListAutoScalingPoliciesResponse, AutoScalingPolicySummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
