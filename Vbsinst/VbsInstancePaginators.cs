...
namespace Oci.VbsinstService
{
    ...
    public class VbsInstancePaginators
    {
        ...
        public VbsInstancePaginators(VbsInstanceClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListVbsInstances operation. This enumerable
        ...
        public IEnumerable<ListVbsInstancesResponse> ListVbsInstancesResponseEnumerator(ListVbsInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListVbsInstancesRequest, ListVbsInstancesResponse>(
                ...
                request => client.ListVbsInstances(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the VbsInstanceSummary objects
        /// contained in responses from the ListVbsInstances operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<VbsInstanceSummary> ListVbsInstancesRecordEnumerator(ListVbsInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListVbsInstancesRequest, ListVbsInstancesResponse, VbsInstanceSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListVbsInstances(request, retryConfiguration, cancellationToken),
                response => response.VbsInstanceSummaryCollection.Items
            );
        }
