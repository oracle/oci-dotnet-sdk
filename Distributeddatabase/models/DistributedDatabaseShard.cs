...
namespace Oci.DistributeddatabaseService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(DistributedDatabaseShardModelConverter))]
    ...
    public class DistributedDatabaseShardModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(DistributedDatabaseShard);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(DistributedDatabaseShard);
            var discriminator = jsonObject["source"].Value<string>();
            switch (discriminator)
            {
                case "NEW_VAULT_AND_CLUSTER":
                    obj = new DistributedDatabaseShardWithExadbXsNewVaultAndCluster();
                    break;
                case "EXADB_XS":
                    obj = new DistributedDatabaseShardWithExadbXs();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under DistributedDatabaseShard! Returning null value.");
            }
            return obj;
        }
    }
