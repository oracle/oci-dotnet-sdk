...
{
    public class SummarizeAnnotationAnalyticsResponse : Oci.Common.IOciResponse
    {
        ...
        public AnnotationAnalyticsAggregationCollection AnnotationAnalyticsAggregationCollection { get; set; }
