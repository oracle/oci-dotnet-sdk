...
{
    public class SummarizeRecordAnalyticsResponse : Oci.Common.IOciResponse
    {
        ...
        public RecordAnalyticsAggregationCollection RecordAnalyticsAggregationCollection { get; set; }
