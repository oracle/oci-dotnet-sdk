...
namespace Oci.PsaService.Models
{
  ...
  public enum OperationType {
      ...
      UnknownEnumValue,
      [EnumMember(Value = "CREATE_PRIVATE_SERVICE_ACCESS")]
      CreatePrivateServiceAccess,
      [EnumMember(Value = "UPDATE_PRIVATE_SERVICE_ACCESS")]
      UpdatePrivateServiceAccess,
      [EnumMember(Value = "DELETE_PRIVATE_SERVICE_ACCESS")]
      DeletePrivateServiceAccess,
      [EnumMember(Value = "MOVE_PRIVATE_SERVICE_ACCESS")]
