...
{
    public class ListTopUtilizedProductLicensesResponse : Oci.Common.IOciResponse
    {
        ...
        public TopUtilizedProductLicenseCollection TopUtilizedProductLicenseCollection { get; set; }
