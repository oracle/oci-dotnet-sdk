...
{
    public class ListProductLicenseConsumersResponse : Oci.Common.IOciResponse
    {
        ...
        public ProductLicenseConsumerCollection ProductLicenseConsumerCollection { get; set; }
