...
namespace Oci.IdentitydataplaneService
{
    ...
    public class DataplaneClient : RegionalClientBase
    {
        ...
        public async Task<GenerateScopedAccessTokenResponse> GenerateScopedAccessToken(GenerateScopedAccessTokenRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
