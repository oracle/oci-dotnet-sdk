...
{
    /// <summary>
    /// Contains collection of helper methods to produce Oci.Common.Waiters for different resources of DataMaskingActivity.
    /// </summary>
    public class DataMaskingActivityWaiters
    {
        private readonly DataMaskingActivityClient client;

        public  DataMaskingActivityWaiters(DataMaskingActivityClient client)
        {
            this.client = client;
        }
