...
{
    /// <summary>
    /// Contains collection of helper methods to produce Oci.Common.Waiters for different resources of ScheduledActivity.
    /// </summary>
    public class ScheduledActivityWaiters
    {
        private readonly ScheduledActivityClient client;

        public  ScheduledActivityWaiters(ScheduledActivityClient client)
        {
            this.client = client;
        }
