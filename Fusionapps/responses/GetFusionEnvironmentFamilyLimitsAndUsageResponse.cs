...
{
    public class GetFusionEnvironmentFamilyLimitsAndUsageResponse : Oci.Common.IOciResponse
    {
        ...
        public FusionEnvironmentFamilyLimitsAndUsage FusionEnvironmentFamilyLimitsAndUsage { get; set; }
