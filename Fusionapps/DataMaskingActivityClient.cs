...
{
    /// <summary>Service client instance for DataMaskingActivity.</summary>
    public class DataMaskingActivityClient : RegionalClientBase
    {
        private readonly RetryConfiguration retryConfiguration;
        private const string basePathWithoutHost = "/20211201";

        public DataMaskingActivityPaginators Paginators { get; }

        public DataMaskingActivityWaiters Waiters { get; }
        ...
        public DataMaskingActivityClient(IBasicAuthenticationDetailsProvider authenticationDetailsProvider, ClientConfiguration clientConfiguration = null, string endpoint = null)
            : base(authenticationDetailsProvider, clientConfiguration)
        {
            ...
            Paginators = new DataMaskingActivityPaginators(this);
            Waiters = new DataMaskingActivityWaiters(this);
        }
