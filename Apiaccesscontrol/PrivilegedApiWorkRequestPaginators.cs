...
namespace Oci.ApiaccesscontrolService
{
    ...
    /// to any list operations of PrivilegedApiWorkRequest where multiple pages of data may be fetched.
    ...
    /// </summary>
    public class PrivilegedApiWorkRequestPaginators
    {
        private readonly PrivilegedApiWorkRequestClient client;

        public PrivilegedApiWorkRequestPaginators(PrivilegedApiWorkRequestClient client)
        {
            this.client = client;
        }
