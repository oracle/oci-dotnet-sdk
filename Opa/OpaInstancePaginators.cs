...
namespace Oci.OpaService
{
    ...
    {
        private readonly OpaInstanceClient client;

        public OpaInstancePaginators(OpaInstanceClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListOpaInstances operation. This enumerable
        ...
        public IEnumerable<ListOpaInstancesResponse> ListOpaInstancesResponseEnumerator(ListOpaInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListOpaInstancesRequest, ListOpaInstancesResponse>(
                ...
                request => client.ListOpaInstances(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the OpaInstanceSummary objects
        /// contained in responses from the ListOpaInstances operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<OpaInstanceSummary> ListOpaInstancesRecordEnumerator(ListOpaInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListOpaInstancesRequest, ListOpaInstancesResponse, OpaInstanceSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListOpaInstances(request, retryConfiguration, cancellationToken),
                response => response.OpaInstanceCollection.Items
            );
        }
