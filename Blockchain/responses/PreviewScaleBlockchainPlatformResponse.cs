...
{
    public class PreviewScaleBlockchainPlatformResponse : Oci.Common.IOciResponse
    {
        ...
        public ScaledBlockchainPlatformPreview ScaledBlockchainPlatformPreview { get; set; }
