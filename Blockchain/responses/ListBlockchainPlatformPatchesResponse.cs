...
{
    public class ListBlockchainPlatformPatchesResponse : Oci.Common.IOciResponse
    {
        ...
        public BlockchainPlatformPatchCollection BlockchainPlatformPatchCollection { get; set; }
