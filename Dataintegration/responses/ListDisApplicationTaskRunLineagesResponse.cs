...
{
    public class ListDisApplicationTaskRunLineagesResponse : Oci.Common.IOciResponse
    {
        ...
        public TaskRunLineageSummaryCollection TaskRunLineageSummaryCollection { get; set; }
