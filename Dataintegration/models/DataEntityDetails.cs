...
namespace Oci.DataintegrationService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(DataEntityDetailsModelConverter))]
    ...
    public class DataEntityDetailsModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(DataEntityDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(DataEntityDetails);
            var discriminator = jsonObject["modelType"].Value<string>();
            switch (discriminator)
            {
                case "FILE_ENTITY":
                    obj = new DataEntityFromFileEntityDetails();
                    break;
                case "VIEW_ENTITY":
                    obj = new DataEntityFromViewEntityDetails();
                    break;
                case "SQL_ENTITY":
                    obj = new DataEntityFromSqlEntityDetails();
                    break;
                case "DATA_STORE_ENTITY":
                    obj = new DataEntityFromDataStoreEntityDetails();
                    break;
                case "OBJECT_ENTITY":
                    obj = new DataEntityFromObjectEntityDetails();
                    break;
                case "TABLE_ENTITY":
