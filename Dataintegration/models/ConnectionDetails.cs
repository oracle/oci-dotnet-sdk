...
namespace Oci.DataintegrationService.Models
{
    ...
    public class ConnectionDetailsModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(ConnectionDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(ConnectionDetails);
            ...
            switch (discriminator)
            {
                ...
                case "ORACLE_EBS_CONNECTION":
                    obj = new ConnectionFromOracleEbsDetails();
                    break;
                case "LAKE_CONNECTION":
                    obj = new ConnectionFromLakeDetails();
                    break;
                case "BIP_CONNECTION":
            ...
            {
                logger.Warn($"The type {discriminator} is not present under ConnectionDetails! Returning null value.");
            }
            return obj;
        }
    }
