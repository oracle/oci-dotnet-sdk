...
namespace Oci.DataintegrationService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PublishedObjectSummaryModelConverter))]
    public class PublishedObjectSummary 
    {
                ///
        /// <value>
    ...
    public class PublishedObjectSummaryModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(PublishedObjectSummary);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(PublishedObjectSummary);
            var discriminator = jsonObject["modelType"].Value<string>();
            switch (discriminator)
            {
                case "PIPELINE_TASK":
                    obj = new PublishedObjectFromPipelineTaskSummary();
                    break;
                case "INTEGRATION_TASK":
                    obj = new PublishedObjectSummaryFromIntegrationTask();
                    break;
