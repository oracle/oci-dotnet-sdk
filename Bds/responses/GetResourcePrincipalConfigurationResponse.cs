...
{
    public class GetResourcePrincipalConfigurationResponse : Oci.Common.OciResponse
    {
        ...
        public ResourcePrincipalConfiguration ResourcePrincipalConfiguration { get; set; }
