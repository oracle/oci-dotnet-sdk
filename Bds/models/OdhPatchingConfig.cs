...
namespace Oci.BdsService.Models
{
    ...
    public class OdhPatchingConfigModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(OdhPatchingConfig);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(OdhPatchingConfig);
            var discriminator = jsonObject["patchingConfigStrategy"].Value<string>();
            switch (discriminator)
            {
                case "DOWNTIME_BASED":
                    obj = new DowntimeBasedOdhPatchingConfig();
                    break;
                case "DOMAIN_BASED":
                    obj = new DomainBasedOdhPatchingConfig();
                    break;
                case "BATCHING_BASED":
                    obj = new BatchingBasedOdhPatchingConfig();
                    break;
            }
