...
{
    public class ListIngressGatewayRouteTablesResponse : Oci.Common.IOciResponse
    {
        ...
        public IngressGatewayRouteTableCollection IngressGatewayRouteTableCollection { get; set; }
