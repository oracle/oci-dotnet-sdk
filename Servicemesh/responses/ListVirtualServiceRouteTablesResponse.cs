...
{
    public class ListVirtualServiceRouteTablesResponse : Oci.Common.IOciResponse
    {
        ...
        public VirtualServiceRouteTableCollection VirtualServiceRouteTableCollection { get; set; }
