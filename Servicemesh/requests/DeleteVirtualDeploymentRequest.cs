...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/servicemesh/DeleteVirtualDeployment.cs.html">here</a> to see an example of how to use DeleteVirtualDeployment request.
    /// </example>
    public class DeleteVirtualDeploymentRequest : Oci.Common.IOciRequest
    {
