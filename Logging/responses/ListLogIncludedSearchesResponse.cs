...
{
    public class ListLogIncludedSearchesResponse : Oci.Common.IOciResponse
    {
        ...
        public LogIncludedSearchSummaryCollection LogIncludedSearchSummaryCollection { get; set; }
