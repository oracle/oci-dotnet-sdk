...
namespace Oci.FleetsoftwareupdateService.Models
{
    ...
    /// 
    /// </summary>
    [JsonConverter(typeof(FsuActionSummaryModelConverter))]
    public class FsuActionSummary 
    {
    ...
    public class FsuActionSummaryModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(FsuActionSummary);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(FsuActionSummary);
            ...
            switch (discriminator)
            {
                case "STAGE":
                    ...
                    break;
                case "APPLY":
                    obj = new ApplyActionSummary();
                    break;
                case "CLEANUP":
                    obj = new CleanupActionSummary();
                    break;
                case "ROLLBACK_AND_REMOVE_TARGET":
                    obj = new RollbackActionSummary();
                    break;
                case "PRECHECK":
                    obj = new PrecheckActionSummary();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under FsuActionSummary! Returning null value.");
            }
            return obj;
        }
    }
