...
namespace Oci.FleetsoftwareupdateService.Models
{
    ...
    /// 
    /// </summary>
    [JsonConverter(typeof(FsuActionModelConverter))]
    public class FsuAction 
    {
    ...
    public class FsuActionModelConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(FsuAction);
            var discriminator = jsonObject["type"].Value<string>();
            switch (discriminator)
            {
                case "CLEANUP":
                    obj = new CleanupAction();
                    break;
                case "PRECHECK":
            ...
            {
                logger.Warn($"The type {discriminator} is not present under FsuAction! Returning null value.");
            }
            return obj;
        }
    }
