...
{
    public class GenerateAnalyticsClusterMemoryEstimateResponse : Oci.Common.IOciResponse
    {
        ...
        public AnalyticsClusterMemoryEstimate AnalyticsClusterMemoryEstimate { get; set; }
