...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/dts/CreateTransferApplianceAdminCredentials.cs.html">here</a> to see an example of how to use CreateTransferApplianceAdminCredentials request.
    /// </example>
    public class CreateTransferApplianceAdminCredentialsRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "AdminPublicKey is required.")]
