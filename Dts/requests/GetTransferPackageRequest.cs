...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/dts/GetTransferPackage.cs.html">here</a> to see an example of how to use GetTransferPackage request.
    /// </example>
    public class GetTransferPackageRequest : Oci.Common.IOciRequest
    {
