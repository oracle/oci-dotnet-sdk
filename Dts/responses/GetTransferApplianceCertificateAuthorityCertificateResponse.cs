...
{
    public class GetTransferApplianceCertificateAuthorityCertificateResponse : Oci.Common.IOciResponse
    {
        ...
        public TransferApplianceCertificate TransferApplianceCertificate { get; set; }
