...
{
    public class GetTransferApplianceEncryptionPassphraseResponse : Oci.Common.IOciResponse
    {
        ...
        public TransferApplianceEncryptionPassphrase TransferApplianceEncryptionPassphrase { get; set; }
