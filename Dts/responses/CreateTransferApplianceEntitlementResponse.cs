...
{
    public class CreateTransferApplianceEntitlementResponse : Oci.Common.IOciResponse
    {
        ...
        public TransferApplianceEntitlement TransferApplianceEntitlement { get; set; }
