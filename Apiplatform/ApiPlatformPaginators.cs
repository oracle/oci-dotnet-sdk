...
namespace Oci.ApiplatformService
{
    ...
    public class ApiPlatformPaginators
    {
        ...
        public ApiPlatformPaginators(ApiPlatformClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListApiPlatformInstances operation. This enumerable
        ...
        public IEnumerable<ListApiPlatformInstancesResponse> ListApiPlatformInstancesResponseEnumerator(ListApiPlatformInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListApiPlatformInstancesRequest, ListApiPlatformInstancesResponse>(
                ...
                request => client.ListApiPlatformInstances(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the ApiPlatformInstanceSummary objects
        /// contained in responses from the ListApiPlatformInstances operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ApiPlatformInstanceSummary> ListApiPlatformInstancesRecordEnumerator(ListApiPlatformInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListApiPlatformInstancesRequest, ListApiPlatformInstancesResponse, ApiPlatformInstanceSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListApiPlatformInstances(request, retryConfiguration, cancellationToken),
                response => response.ApiPlatformInstanceCollection.Items
            );
        }
