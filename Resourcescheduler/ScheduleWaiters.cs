...
{
    /// <summary>
    /// Contains collection of helper methods to produce Oci.Common.Waiters for different resources of Schedule.
    /// </summary>
    public class ScheduleWaiters
    {
        private readonly ScheduleClient client;

        public  ScheduleWaiters(ScheduleClient client)
        {
            this.client = client;
        }
        ...
        public Waiter<GetScheduleRequest, GetScheduleResponse> ForSchedule(GetScheduleRequest request, WaiterConfiguration config, params Schedule.LifecycleStateEnum[] targetStates)
        {
            var agent = new WaiterAgent<GetScheduleRequest, GetScheduleResponse>(
                ...
                targetStates.Contains(Schedule.LifecycleStateEnum.Deleted)
            );
