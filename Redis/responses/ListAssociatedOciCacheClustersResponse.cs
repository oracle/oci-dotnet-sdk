...
{
    public class ListAssociatedOciCacheClustersResponse : Oci.Common.OciResponse
    {
        ...
        public AssociatedOciCacheClusterCollection AssociatedOciCacheClusterCollection { get; set; }
