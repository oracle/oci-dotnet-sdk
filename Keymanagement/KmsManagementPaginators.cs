...
namespace Oci.KeymanagementService
{
    ...
    public class KmsManagementPaginators
    {
        ...
        /// <summary>
        /// Creates a new enumerable which will iterate over the KeyVersionSummary objects
        /// contained in responses from the ListKeyVersions operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<KeyVersionSummary> ListKeyVersionsRecordEnumerator(ListKeyVersionsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListKeyVersionsRequest, ListKeyVersionsResponse, KeyVersionSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
        ...
        /// <summary>
        /// Creates a new enumerable which will iterate over the KeySummary objects
        /// contained in responses from the ListKeys operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<KeySummary> ListKeysRecordEnumerator(ListKeysRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListKeysRequest, ListKeysResponse, KeySummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
