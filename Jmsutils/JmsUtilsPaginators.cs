...
namespace Oci.JmsutilsService
{
    ...
    {
        private readonly JmsUtilsClient client;

        public JmsUtilsPaginators(JmsUtilsClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListJavaMigrationAnalysis operation. This enumerable
        ...
        public IEnumerable<ListJavaMigrationAnalysisResponse> ListJavaMigrationAnalysisResponseEnumerator(ListJavaMigrationAnalysisRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListJavaMigrationAnalysisRequest, ListJavaMigrationAnalysisResponse>(
                ...
                request => client.ListJavaMigrationAnalysis(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the JavaMigrationAnalysisSummary objects
        /// contained in responses from the ListJavaMigrationAnalysis operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<JavaMigrationAnalysisSummary> ListJavaMigrationAnalysisRecordEnumerator(ListJavaMigrationAnalysisRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListJavaMigrationAnalysisRequest, ListJavaMigrationAnalysisResponse, JavaMigrationAnalysisSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListJavaMigrationAnalysis(request, retryConfiguration, cancellationToken),
                response => response.JavaMigrationAnalysisCollection.Items
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListPerformanceTuningAnalysis operation. This enumerable
        /// will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ListPerformanceTuningAnalysisResponse> ListPerformanceTuningAnalysisResponseEnumerator(ListPerformanceTuningAnalysisRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListPerformanceTuningAnalysisRequest, ListPerformanceTuningAnalysisResponse>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListPerformanceTuningAnalysis(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the PerformanceTuningAnalysisSummary objects
        /// contained in responses from the ListPerformanceTuningAnalysis operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<PerformanceTuningAnalysisSummary> ListPerformanceTuningAnalysisRecordEnumerator(ListPerformanceTuningAnalysisRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListPerformanceTuningAnalysisRequest, ListPerformanceTuningAnalysisResponse, PerformanceTuningAnalysisSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListPerformanceTuningAnalysis(request, retryConfiguration, cancellationToken),
                response => response.PerformanceTuningAnalysisCollection.Items
            );
        }
