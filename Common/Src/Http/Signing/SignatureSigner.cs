...
namespace Oci.Common.Http.Signing
{
    public class SignatureSigner
    {
        ...
        /// <param name="algorithm">The algorithm to sign</param>
        /// <returns>An RSA signature of the message made using given private key and algorithm</returns>
        /// 
        public byte[] sign(RsaKeyParameters privateKey, byte[] message, string algorithm)
        {
            try
            {
