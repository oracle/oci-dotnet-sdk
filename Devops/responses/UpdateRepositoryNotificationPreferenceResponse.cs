...
{
    public class UpdateRepositoryNotificationPreferenceResponse : Oci.Common.OciResponse
    {
        ...
        public RepositoryNotificationPreference RepositoryNotificationPreference { get; set; }
