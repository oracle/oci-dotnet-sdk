...
{
    public class UpdateProjectNotificationPreferenceResponse : Oci.Common.OciResponse
    {
        ...
        public ProjectNotificationPreference ProjectNotificationPreference { get; set; }
