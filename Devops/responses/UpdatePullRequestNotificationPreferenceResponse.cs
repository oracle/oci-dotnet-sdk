...
{
    public class UpdatePullRequestNotificationPreferenceResponse : Oci.Common.OciResponse
    {
        ...
        public PullRequestNotificationPreference PullRequestNotificationPreference { get; set; }
