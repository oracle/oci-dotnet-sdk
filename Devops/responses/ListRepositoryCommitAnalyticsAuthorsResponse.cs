...
{
    public class ListRepositoryCommitAnalyticsAuthorsResponse : Oci.Common.OciResponse
    {
        ...
        public CommitAnalyticsAuthorCollection CommitAnalyticsAuthorCollection { get; set; }
