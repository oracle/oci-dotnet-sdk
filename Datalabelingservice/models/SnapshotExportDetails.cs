...
namespace Oci.DatalabelingService.Models
{
    ...
    public class SnapshotExportDetailsModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(SnapshotExportDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(SnapshotExportDetails);
            var discriminator = jsonObject["exportType"].Value<string>();
            switch (discriminator)
            {
                case "OBJECT_STORAGE":
                    obj = new ObjectStorageSnapshotExportDetails();
                    break;
            }
