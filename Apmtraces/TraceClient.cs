...
namespace Oci.ApmtracesService
{
    ...
    public class TraceClient : RegionalClientBase
    {
        ...
        public async Task<GetSpanResponse> GetSpan(GetSpanRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
