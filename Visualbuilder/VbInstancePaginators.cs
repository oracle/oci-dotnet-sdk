...
namespace Oci.VisualbuilderService
{
    ...
    public class VbInstancePaginators
    {
        ...
        public VbInstancePaginators(VbInstanceClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListVbInstances operation. This enumerable
        ...
        public IEnumerable<ListVbInstancesResponse> ListVbInstancesResponseEnumerator(ListVbInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListVbInstancesRequest, ListVbInstancesResponse>(
                ...
                request => client.ListVbInstances(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the VbInstanceSummary objects
        /// contained in responses from the ListVbInstances operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<VbInstanceSummary> ListVbInstancesRecordEnumerator(ListVbInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListVbInstancesRequest, ListVbInstancesResponse, VbInstanceSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListVbInstances(request, retryConfiguration, cancellationToken),
                response => response.VbInstanceSummaryCollection.Items
            );
        }
