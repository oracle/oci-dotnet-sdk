...
namespace Oci.VisualbuilderService.Models
{
    ...
    public class WorkRequestSummary 
    {
        ...
        public enum OperationTypeEnum {
            ...
            UnknownEnumValue,
            [EnumMember(Value = "CREATE_VB_INSTANCE")]
            CreateVbInstance,
            [EnumMember(Value = "UPDATE_VB_INSTANCE")]
            UpdateVbInstance,
            [EnumMember(Value = "STOP_VB_INSTANCE")]
            StopVbInstance,
            [EnumMember(Value = "START_VB_INSTANCE")]
            StartVbInstance,
            [EnumMember(Value = "DELETE_VB_INSTANCE")]
            DeleteVbInstance
        };
