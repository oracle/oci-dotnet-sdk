...
namespace Oci.AppmgmtcontrolService
{
    ...
    public class AppmgmtControlPaginators
    {
        ...
        public AppmgmtControlPaginators(AppmgmtControlClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListMonitoredInstances operation. This enumerable
        ...
        public IEnumerable<ListMonitoredInstancesResponse> ListMonitoredInstancesResponseEnumerator(ListMonitoredInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListMonitoredInstancesRequest, ListMonitoredInstancesResponse>(
                ...
                request => client.ListMonitoredInstances(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the MonitoredInstanceSummary objects
        /// contained in responses from the ListMonitoredInstances operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<MonitoredInstanceSummary> ListMonitoredInstancesRecordEnumerator(ListMonitoredInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListMonitoredInstancesRequest, ListMonitoredInstancesResponse, MonitoredInstanceSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListMonitoredInstances(request, retryConfiguration, cancellationToken),
                response => response.MonitoredInstanceCollection.Items
            );
        }
