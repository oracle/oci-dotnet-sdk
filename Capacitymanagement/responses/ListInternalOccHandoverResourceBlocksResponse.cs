...
{
    public class ListInternalOccHandoverResourceBlocksResponse : Oci.Common.OciResponse
    {
        ...
        public OccHandoverResourceBlockCollection OccHandoverResourceBlockCollection { get; set; }
