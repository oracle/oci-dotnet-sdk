...
{
    public class ListInternalOccmDemandSignalItemsResponse : Oci.Common.OciResponse
    {
        ...
        public InternalOccmDemandSignalItemCollection InternalOccmDemandSignalItemCollection { get; set; }
