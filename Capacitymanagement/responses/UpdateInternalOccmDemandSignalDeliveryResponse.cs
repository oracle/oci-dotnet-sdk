...
{
    public class UpdateInternalOccmDemandSignalDeliveryResponse : Oci.Common.OciResponse
    {
        ...
        public InternalOccmDemandSignalDelivery InternalOccmDemandSignalDelivery { get; set; }
