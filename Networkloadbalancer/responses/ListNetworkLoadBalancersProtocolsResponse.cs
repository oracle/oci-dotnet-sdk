...
{
    public class ListNetworkLoadBalancersProtocolsResponse : Oci.Common.IOciResponse
    {
        ...
        public NetworkLoadBalancersProtocolCollection NetworkLoadBalancersProtocolCollection { get; set; }
