...
{
    public class ListNetworkLoadBalancerHealthsResponse : Oci.Common.IOciResponse
    {
        ...
        public NetworkLoadBalancerHealthCollection NetworkLoadBalancerHealthCollection { get; set; }
