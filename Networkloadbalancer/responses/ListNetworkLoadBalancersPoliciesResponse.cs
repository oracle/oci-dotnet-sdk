...
{
    public class ListNetworkLoadBalancersPoliciesResponse : Oci.Common.IOciResponse
    {
        ...
        public NetworkLoadBalancersPolicyCollection NetworkLoadBalancersPolicyCollection { get; set; }
