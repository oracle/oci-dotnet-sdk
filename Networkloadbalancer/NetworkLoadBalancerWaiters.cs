...
{
    /// <summary>
    /// Contains collection of helper methods to produce Oci.Common.Waiters for different resources of NetworkLoadBalancer.
    /// </summary>
    public class NetworkLoadBalancerWaiters
    {
        private readonly NetworkLoadBalancerClient client;

        public  NetworkLoadBalancerWaiters(NetworkLoadBalancerClient client)
        {
            this.client = client;
        }
