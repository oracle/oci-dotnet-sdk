...
{
    public class ListBulkEditTagsResourceTypesResponse : Oci.Common.IOciResponse
    {
        ...
        public BulkEditTagsResourceTypeCollection BulkEditTagsResourceTypeCollection { get; set; }
