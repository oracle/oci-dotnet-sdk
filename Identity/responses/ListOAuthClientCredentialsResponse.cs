...
{
    public class ListOAuthClientCredentialsResponse : Oci.Common.IOciResponse
    {
        ...
        public System.Collections.Generic.List<OAuth2ClientCredentialSummary> Items { get; set; }
