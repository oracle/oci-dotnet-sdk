...
{
    public class ListStandardTagNamespacesResponse : Oci.Common.IOciResponse
    {
        ...
        public System.Collections.Generic.List<StandardTagNamespaceTemplateSummary> Items { get; set; }
