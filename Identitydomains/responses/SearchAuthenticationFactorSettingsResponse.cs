...
{
    public class SearchAuthenticationFactorSettingsResponse : Oci.Common.IOciResponse
    {
        ...
        public AuthenticationFactorSettings AuthenticationFactorSettings { get; set; }
