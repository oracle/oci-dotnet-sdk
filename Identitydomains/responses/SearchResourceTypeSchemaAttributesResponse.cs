...
{
    public class SearchResourceTypeSchemaAttributesResponse : Oci.Common.IOciResponse
    {
        ...
        public ResourceTypeSchemaAttributes ResourceTypeSchemaAttributes { get; set; }
