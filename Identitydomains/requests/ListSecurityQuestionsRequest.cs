...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/ListSecurityQuestions.cs.html">here</a> to see an example of how to use ListSecurityQuestions request.
    /// </example>
