...
namespace Oci.IdentitydomainsService.Models
{
    ...
    public class Group 
    {
        ...
        [JsonProperty(PropertyName = "urn:ietf:params:scim:schemas:oracle:idcs:extension:requestable:Group")]
        public ExtensionRequestableGroup UrnIetfParamsScimSchemasOracleIdcsExtensionRequestableGroup { get; set; }
        
        [JsonProperty(PropertyName = "urn:ietf:params:scim:schemas:oracle:idcs:extension:dbcs:Group")]
        public ExtensionDbcsGroup UrnIetfParamsScimSchemasOracleIdcsExtensionDbcsGroup { get; set; }
        
        [JsonProperty(PropertyName = "urn:ietf:params:scim:schemas:oracle:idcs:extension:dynamic:Group")]
        public ExtensionDynamicGroup UrnIetfParamsScimSchemasOracleIdcsExtensionDynamicGroup { get; set; }
