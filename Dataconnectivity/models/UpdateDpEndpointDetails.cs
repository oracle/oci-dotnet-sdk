...
namespace Oci.DataconnectivityService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(UpdateDpEndpointDetailsModelConverter))]
    ...
    public class UpdateDpEndpointDetailsModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(UpdateDpEndpointDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(UpdateDpEndpointDetails);
            var discriminator = jsonObject["modelType"].Value<string>();
            switch (discriminator)
            {
                case "PUBLIC_END_POINT":
                    obj = new UpdateDpEndpointFromPublic();
                    break;
                case "PRIVATE_END_POINT":
                    obj = new UpdateDpEndpointFromPrivate();
                    break;
            }
