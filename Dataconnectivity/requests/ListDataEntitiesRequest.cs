...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/dataconnectivity/ListDataEntities.cs.html">here</a> to see an example of how to use ListDataEntities request.
    /// </example>
    public class ListDataEntitiesRequest : Oci.Common.IOciRequest
    {
        ...
        /// This parameter can be used to set the api response type to preview.
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "apiMode")]
        public System.Nullable<ApiModeEnum> ApiMode { get; set; }
