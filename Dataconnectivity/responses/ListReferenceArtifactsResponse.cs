...
{
    public class ListReferenceArtifactsResponse : Oci.Common.IOciResponse
    {
        ...
        public ReferenceArtifactSummaryCollection ReferenceArtifactSummaryCollection { get; set; }
