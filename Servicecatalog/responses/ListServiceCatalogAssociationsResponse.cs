...
{
    public class ListServiceCatalogAssociationsResponse : Oci.Common.IOciResponse
    {
        ...
        public ServiceCatalogAssociationCollection ServiceCatalogAssociationCollection { get; set; }
