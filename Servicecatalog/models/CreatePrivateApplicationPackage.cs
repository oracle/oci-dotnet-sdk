...
namespace Oci.ServicecatalogService.Models
{
    ...
    public class CreatePrivateApplicationPackageModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(CreatePrivateApplicationPackage);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(CreatePrivateApplicationPackage);
            var discriminator = jsonObject["packageType"].Value<string>();
            switch (discriminator)
            {
                case "STACK":
                    obj = new CreatePrivateApplicationStackPackage();
                    break;
            }
