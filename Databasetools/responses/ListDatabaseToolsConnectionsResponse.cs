...
{
    public class ListDatabaseToolsConnectionsResponse : Oci.Common.IOciResponse
    {
        ...
        public DatabaseToolsConnectionCollection DatabaseToolsConnectionCollection { get; set; }
