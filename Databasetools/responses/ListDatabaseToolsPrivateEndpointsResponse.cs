...
{
    public class ListDatabaseToolsPrivateEndpointsResponse : Oci.Common.IOciResponse
    {
        ...
        public DatabaseToolsPrivateEndpointCollection DatabaseToolsPrivateEndpointCollection { get; set; }
