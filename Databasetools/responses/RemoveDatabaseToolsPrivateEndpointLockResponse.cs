...
{
    public class RemoveDatabaseToolsPrivateEndpointLockResponse : Oci.Common.IOciResponse
    {
        ...
        public DatabaseToolsPrivateEndpoint DatabaseToolsPrivateEndpoint { get; set; }
