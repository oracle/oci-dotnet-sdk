...
{
    public class ListDatabaseToolsEndpointServicesResponse : Oci.Common.IOciResponse
    {
        ...
        public DatabaseToolsEndpointServiceCollection DatabaseToolsEndpointServiceCollection { get; set; }
