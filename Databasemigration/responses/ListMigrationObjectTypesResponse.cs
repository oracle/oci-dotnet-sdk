...
{
    public class ListMigrationObjectTypesResponse : Oci.Common.IOciResponse
    {
        ...
        public MigrationObjectTypeSummaryCollection MigrationObjectTypeSummaryCollection { get; set; }
