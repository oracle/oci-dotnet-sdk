    ...
    public class VaultsPaginators
    {
        ...
        public IEnumerable<ListSecretVersionsResponse> ListSecretVersionsResponseEnumerator(ListSecretVersionsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListSecretVersionsRequest, ListSecretVersionsResponse>(
                ...
                request => client.ListSecretVersions(request, retryConfiguration, cancellationToken).Result
            );
        }
        ...
        public IEnumerable<ListSecretsResponse> ListSecretsResponseEnumerator(ListSecretsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListSecretsRequest, ListSecretsResponse>(
                ...
                request => client.ListSecrets(request, retryConfiguration, cancellationToken).Result
            );
        }
