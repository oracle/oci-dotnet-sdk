...
namespace Oci.StackmonitoringService
{
    ...
    public class StackMonitoringWaiters
    {
        ...
        {
            return this.ForProcessSet(request, WaiterConfiguration.DefaultWaiterConfiguration, targetStates);
        }
        ...
        {
            var agent = new WaiterAgent<GetProcessSetRequest, GetProcessSetResponse>(
                request,
                request => client.GetProcessSet(request),
                response => targetStates.Contains(response.ProcessSet.LifecycleState.Value),
                targetStates.Contains(LifecycleState.Deleted)
            );
            return new Waiter<GetProcessSetRequest, GetProcessSetResponse>(config, agent);
        }
        /// <summary>
        /// Creates a waiter using default wait configuration.
        /// </summary>
