...
namespace Oci.StackmonitoringService.Models
{
    ...
    public class UpdateConfigDetailsModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(UpdateConfigDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(UpdateConfigDetails);
            ...
            switch (discriminator)
            {
                ...
                case "LICENSE_ENTERPRISE_EXTENSIBILITY":
                    ...
                    break;
                case "AUTO_PROMOTE":
                    obj = new UpdateAutoPromoteConfigDetails();
                    break;
