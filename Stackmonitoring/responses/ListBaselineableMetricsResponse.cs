...
{
    public class ListBaselineableMetricsResponse : Oci.Common.IOciResponse
    {
        ...
        public BaselineableMetricSummaryCollection BaselineableMetricSummaryCollection { get; set; }
