...
{
    public class ListMonitoredResourceTypesResponse : Oci.Common.IOciResponse
    {
        ...
        public MonitoredResourceTypesCollection MonitoredResourceTypesCollection { get; set; }
