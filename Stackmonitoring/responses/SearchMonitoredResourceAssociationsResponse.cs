...
{
    public class SearchMonitoredResourceAssociationsResponse : Oci.Common.IOciResponse
    {
        ...
        public MonitoredResourceAssociationsCollection MonitoredResourceAssociationsCollection { get; set; }
