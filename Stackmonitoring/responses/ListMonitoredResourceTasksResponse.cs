...
{
    public class ListMonitoredResourceTasksResponse : Oci.Common.IOciResponse
    {
        ...
        public MonitoredResourceTasksCollection MonitoredResourceTasksCollection { get; set; }
