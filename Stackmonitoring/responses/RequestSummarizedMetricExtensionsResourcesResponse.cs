...
{
    public class RequestSummarizedMetricExtensionsResourcesResponse : Oci.Common.OciResponse
    {
        ...
        public MetricExtensionResourceAggregationCollection MetricExtensionResourceAggregationCollection { get; set; }
