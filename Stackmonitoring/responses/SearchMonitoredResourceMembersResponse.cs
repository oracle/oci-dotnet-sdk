...
{
    public class SearchMonitoredResourceMembersResponse : Oci.Common.IOciResponse
    {
        ...
        public MonitoredResourceMembersCollection MonitoredResourceMembersCollection { get; set; }
