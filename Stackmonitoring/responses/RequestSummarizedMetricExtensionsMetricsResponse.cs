...
{
    public class RequestSummarizedMetricExtensionsMetricsResponse : Oci.Common.OciResponse
    {
        ...
        public MetricExtensionMetricAggregationCollection MetricExtensionMetricAggregationCollection { get; set; }
