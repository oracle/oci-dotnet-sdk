...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/8.1.0/objectstorage/ListMultipartUploadParts.cs.html">here</a> to see an example of how to use ListMultipartUploadParts request.
    /// </example>
