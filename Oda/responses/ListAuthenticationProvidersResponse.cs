...
{
    public class ListAuthenticationProvidersResponse : Oci.Common.IOciResponse
    {
        ...
        public AuthenticationProviderCollection AuthenticationProviderCollection { get; set; }
