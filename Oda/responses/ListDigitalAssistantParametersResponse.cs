...
{
    public class ListDigitalAssistantParametersResponse : Oci.Common.IOciResponse
    {
        ...
        public DigitalAssistantParameterCollection DigitalAssistantParameterCollection { get; set; }
