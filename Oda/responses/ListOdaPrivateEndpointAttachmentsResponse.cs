...
{
    public class ListOdaPrivateEndpointAttachmentsResponse : Oci.Common.IOciResponse
    {
        ...
        public OdaPrivateEndpointAttachmentCollection OdaPrivateEndpointAttachmentCollection { get; set; }
