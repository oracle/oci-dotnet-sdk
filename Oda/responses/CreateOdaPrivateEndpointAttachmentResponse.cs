...
{
    public class CreateOdaPrivateEndpointAttachmentResponse : Oci.Common.IOciResponse
    {
        ...
        public OdaPrivateEndpointAttachment OdaPrivateEndpointAttachment { get; set; }
