...
{
    public class ListOdaPrivateEndpointScanProxiesResponse : Oci.Common.IOciResponse
    {
        ...
        public OdaPrivateEndpointScanProxyCollection OdaPrivateEndpointScanProxyCollection { get; set; }
