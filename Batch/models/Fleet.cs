...
namespace Oci.BatchService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(FleetModelConverter))]
    public class Fleet 
    {
                ///
        /// <value>
    ...
    public class FleetModelConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under Fleet! Returning null value.");
            }
            return obj;
        }
    }
