...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/8.0.0/datacatalog/AttachCatalogPrivateEndpoint.cs.html">here</a> to see an example of how to use AttachCatalogPrivateEndpoint request.
    /// </example>
