...
{
    public class RequestSummarizedTrendResponderExecutionsResponse : Oci.Common.IOciResponse
    {
        ...
        public ResponderExecutionTrendAggregationCollection ResponderExecutionTrendAggregationCollection { get; set; }
