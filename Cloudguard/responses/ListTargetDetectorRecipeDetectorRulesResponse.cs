...
{
    public class ListTargetDetectorRecipeDetectorRulesResponse : Oci.Common.IOciResponse
    {
        ...
        public TargetDetectorRecipeDetectorRuleCollection TargetDetectorRecipeDetectorRuleCollection { get; set; }
