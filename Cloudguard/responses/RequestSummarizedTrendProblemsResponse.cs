...
{
    public class RequestSummarizedTrendProblemsResponse : Oci.Common.IOciResponse
    {
        ...
        public ProblemTrendAggregationCollection ProblemTrendAggregationCollection { get; set; }
