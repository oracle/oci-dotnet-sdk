...
{
    public class RequestSummarizedTrendSecurityScoresResponse : Oci.Common.IOciResponse
    {
        ...
        public SecurityScoreTrendAggregationCollection SecurityScoreTrendAggregationCollection { get; set; }
