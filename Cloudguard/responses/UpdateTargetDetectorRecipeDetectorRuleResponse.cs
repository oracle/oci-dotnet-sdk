...
{
    public class UpdateTargetDetectorRecipeDetectorRuleResponse : Oci.Common.IOciResponse
    {
        ...
        public TargetDetectorRecipeDetectorRule TargetDetectorRecipeDetectorRule { get; set; }
