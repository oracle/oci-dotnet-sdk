...
{
    public class ListSightingImpactedResourcesResponse : Oci.Common.IOciResponse
    {
        ...
        public SightingImpactedResourceCollection SightingImpactedResourceCollection { get; set; }
