...
{
    public class UpdateResponderRecipeResponderRuleResponse : Oci.Common.IOciResponse
    {
        ...
        public ResponderRecipeResponderRule ResponderRecipeResponderRule { get; set; }
