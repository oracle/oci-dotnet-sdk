...
{
    public class RequestSummarizedResponderExecutionsResponse : Oci.Common.IOciResponse
    {
        ...
        public ResponderExecutionAggregationCollection ResponderExecutionAggregationCollection { get; set; }
