...
{
    public class ListResourceProfileImpactedResourcesResponse : Oci.Common.IOciResponse
    {
        ...
        public ResourceProfileImpactedResourceCollection ResourceProfileImpactedResourceCollection { get; set; }
