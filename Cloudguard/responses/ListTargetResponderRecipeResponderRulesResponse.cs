...
{
    public class ListTargetResponderRecipeResponderRulesResponse : Oci.Common.IOciResponse
    {
        ...
        public TargetResponderRecipeResponderRuleCollection TargetResponderRecipeResponderRuleCollection { get; set; }
