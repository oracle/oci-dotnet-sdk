...
{
    public class UpdateTargetResponderRecipeResponderRuleResponse : Oci.Common.IOciResponse
    {
        ...
        public TargetResponderRecipeResponderRule TargetResponderRecipeResponderRule { get; set; }
