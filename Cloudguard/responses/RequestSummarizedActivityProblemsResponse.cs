...
{
    public class RequestSummarizedActivityProblemsResponse : Oci.Common.IOciResponse
    {
        ...
        public ActivityProblemAggregationCollection ActivityProblemAggregationCollection { get; set; }
