...
{
    public class RequestSummarizedSecurityScoresResponse : Oci.Common.IOciResponse
    {
        ...
        public SecurityScoreAggregationCollection SecurityScoreAggregationCollection { get; set; }
