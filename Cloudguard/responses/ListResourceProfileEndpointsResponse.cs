...
{
    public class ListResourceProfileEndpointsResponse : Oci.Common.IOciResponse
    {
        ...
        public ResourceProfileEndpointCollection ResourceProfileEndpointCollection { get; set; }
