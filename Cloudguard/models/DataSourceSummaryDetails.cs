...
namespace Oci.CloudguardService.Models
{
    ...
    public class DataSourceSummaryDetailsModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(DataSourceSummaryDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(DataSourceSummaryDetails);
            ...
            {
                logger.Warn($"The type {discriminator} is not present under DataSourceSummaryDetails! Returning null value.");
            }
            return obj;
        }
    }
