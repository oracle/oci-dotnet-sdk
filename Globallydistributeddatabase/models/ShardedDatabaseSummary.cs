...
namespace Oci.GloballydistributeddatabaseService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(ShardedDatabaseSummaryModelConverter))]
    public class ShardedDatabaseSummary 
    {
        ...
        public System.Nullable<ShardedDatabase.LifecycleStateEnum> LifecycleState { get; set; }
    ...
    public class ShardedDatabaseSummaryModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(ShardedDatabaseSummary);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(ShardedDatabaseSummary);
            var discriminator = jsonObject["dbDeploymentType"].Value<string>();
            switch (discriminator)
            {
                case "DEDICATED":
                    obj = new DedicatedShardedDatabaseSummary();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under ShardedDatabaseSummary! Returning null value.");
            }
            return obj;
        }
    }
