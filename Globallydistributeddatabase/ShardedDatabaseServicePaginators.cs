...
namespace Oci.GloballydistributeddatabaseService
{
    ...
    public class ShardedDatabaseServicePaginators
    {
        ...
        public ShardedDatabaseServicePaginators(ShardedDatabaseServiceClient client)
        {
            this.client = client;
        }
        ...
        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListShardedDatabases operation. This enumerable
        /// will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ListShardedDatabasesResponse> ListShardedDatabasesResponseEnumerator(ListShardedDatabasesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListShardedDatabasesRequest, ListShardedDatabasesResponse>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListShardedDatabases(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the ShardedDatabaseSummary objects
        /// contained in responses from the ListShardedDatabases operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ShardedDatabaseSummary> ListShardedDatabasesRecordEnumerator(ListShardedDatabasesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListShardedDatabasesRequest, ListShardedDatabasesResponse, ShardedDatabaseSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListShardedDatabases(request, retryConfiguration, cancellationToken),
                response => response.ShardedDatabaseCollection.Items
            );
        }
