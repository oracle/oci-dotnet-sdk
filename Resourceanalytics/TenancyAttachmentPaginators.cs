...
namespace Oci.ResourceanalyticsService
{
    ...
    /// to any list operations of TenancyAttachment where multiple pages of data may be fetched.
    ...
    public class TenancyAttachmentPaginators
    {
        ...
        public TenancyAttachmentPaginators(TenancyAttachmentClient client)
        {
            this.client = client;
        }
