...
namespace Oci.ResourceanalyticsService
{
    ...
    public class ResourceAnalyticsInstancePaginators
    {
        ...
        public ResourceAnalyticsInstancePaginators(ResourceAnalyticsInstanceClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListResourceAnalyticsInstances operation. This enumerable
        ...
        public IEnumerable<ListResourceAnalyticsInstancesResponse> ListResourceAnalyticsInstancesResponseEnumerator(ListResourceAnalyticsInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListResourceAnalyticsInstancesRequest, ListResourceAnalyticsInstancesResponse>(
                ...
                request => client.ListResourceAnalyticsInstances(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the ResourceAnalyticsInstanceSummary objects
        /// contained in responses from the ListResourceAnalyticsInstances operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ResourceAnalyticsInstanceSummary> ListResourceAnalyticsInstancesRecordEnumerator(ListResourceAnalyticsInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListResourceAnalyticsInstancesRequest, ListResourceAnalyticsInstancesResponse, ResourceAnalyticsInstanceSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListResourceAnalyticsInstances(request, retryConfiguration, cancellationToken),
                response => response.ResourceAnalyticsInstanceCollection.Items
            );
        }
