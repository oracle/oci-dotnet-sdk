...
namespace Oci.AianomalydetectionService.Models
{
    ...
    public class OutputJobDetailsModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(OutputJobDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(OutputJobDetails);
            ...
            {
                logger.Warn($"The type {discriminator} is not present under OutputJobDetails! Returning null value.");
            }
            return obj;
        }
    }
