...
namespace Oci.AianomalydetectionService
{
    ...
    public class AnomalyDetectionPaginators
    {
        ...
        public AnomalyDetectionPaginators(AnomalyDetectionClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListAiPrivateEndpoints operation. This enumerable
        ...
        public IEnumerable<ListAiPrivateEndpointsResponse> ListAiPrivateEndpointsResponseEnumerator(ListAiPrivateEndpointsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListAiPrivateEndpointsRequest, ListAiPrivateEndpointsResponse>(
                ...
                request => client.ListAiPrivateEndpoints(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the AiPrivateEndpointSummary objects
        /// contained in responses from the ListAiPrivateEndpoints operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<AiPrivateEndpointSummary> ListAiPrivateEndpointsRecordEnumerator(ListAiPrivateEndpointsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListAiPrivateEndpointsRequest, ListAiPrivateEndpointsResponse, AiPrivateEndpointSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListAiPrivateEndpoints(request, retryConfiguration, cancellationToken),
                response => response.AiPrivateEndpointCollection.Items
            );
        }
        ...
        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListDetectAnomalyJobs operation. This enumerable
        /// will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ListDetectAnomalyJobsResponse> ListDetectAnomalyJobsResponseEnumerator(ListDetectAnomalyJobsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListDetectAnomalyJobsRequest, ListDetectAnomalyJobsResponse>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListDetectAnomalyJobs(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the DetectAnomalyJobSummary objects
        /// contained in responses from the ListDetectAnomalyJobs operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<DetectAnomalyJobSummary> ListDetectAnomalyJobsRecordEnumerator(ListDetectAnomalyJobsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListDetectAnomalyJobsRequest, ListDetectAnomalyJobsResponse, DetectAnomalyJobSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListDetectAnomalyJobs(request, retryConfiguration, cancellationToken),
                response => response.DetectAnomalyJobCollection.Items
            );
        }
