...
namespace Oci.MarketplacepublisherService.Models
{
    ...
    /// 
    /// </summary>
    [JsonConverter(typeof(UpdateListingRevisionAttachmentDetailsModelConverter))]
    public class UpdateListingRevisionAttachmentDetails 
    {
    ...
    public class UpdateListingRevisionAttachmentDetailsModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(UpdateListingRevisionAttachmentDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(UpdateListingRevisionAttachmentDetails);
