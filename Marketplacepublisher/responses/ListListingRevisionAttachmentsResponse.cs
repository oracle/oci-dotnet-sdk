...
{
    public class ListListingRevisionAttachmentsResponse : Oci.Common.IOciResponse
    {
        ...
        public ListingRevisionAttachmentCollection ListingRevisionAttachmentCollection { get; set; }
