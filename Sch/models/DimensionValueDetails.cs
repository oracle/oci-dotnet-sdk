...
namespace Oci.SchService.Models
{
    ...
    public class DimensionValueDetailsModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(DimensionValueDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(DimensionValueDetails);
            var discriminator = jsonObject["kind"].Value<string>();
            switch (discriminator)
            {
                case "static":
                    obj = new StaticDimensionValue();
                    break;
                case "jmesPath":
                    obj = new JmesPathDimensionValue();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under DimensionValueDetails! Returning null value.");
            }
            return obj;
        }
    }
