...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/8.0.0/database/GetCloudVmCluster.cs.html">here</a> to see an example of how to use GetCloudVmCluster request.
    /// </example>
