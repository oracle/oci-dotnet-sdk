...
{
    public class GetExadbVmClusterUpdateHistoryEntryResponse : Oci.Common.OciResponse
    {
        ...
        public ExadbVmClusterUpdateHistoryEntry ExadbVmClusterUpdateHistoryEntry { get; set; }
