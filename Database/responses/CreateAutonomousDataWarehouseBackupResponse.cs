...
{
    public class CreateAutonomousDataWarehouseBackupResponse : Oci.Common.IOciResponse
    {
        ...
        public AutonomousDataWarehouseBackup AutonomousDataWarehouseBackup { get; set; }
