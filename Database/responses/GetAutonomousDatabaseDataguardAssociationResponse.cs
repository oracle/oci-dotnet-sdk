...
{
    public class GetAutonomousDatabaseDataguardAssociationResponse : Oci.Common.IOciResponse
    {
        ...
        public AutonomousDatabaseDataguardAssociation AutonomousDatabaseDataguardAssociation { get; set; }
