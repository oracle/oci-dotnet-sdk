...
{
    public class AuthorizeSubscriptionPaymentResponse : Oci.Common.IOciResponse
    {
        ...
        public AuthorizeSubscriptionPaymentReceipt AuthorizeSubscriptionPaymentReceipt { get; set; }
