...
{
    public class SummarizeManagementAgentPluginCountsResponse : Oci.Common.IOciResponse
    {
        ...
        public ManagementAgentPluginAggregationCollection ManagementAgentPluginAggregationCollection { get; set; }
