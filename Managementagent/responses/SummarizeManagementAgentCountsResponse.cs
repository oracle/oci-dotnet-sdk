...
{
    public class SummarizeManagementAgentCountsResponse : Oci.Common.IOciResponse
    {
        ...
        public ManagementAgentAggregationCollection ManagementAgentAggregationCollection { get; set; }
