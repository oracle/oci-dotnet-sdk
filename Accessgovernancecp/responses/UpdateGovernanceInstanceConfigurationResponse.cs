...
{
    public class UpdateGovernanceInstanceConfigurationResponse : Oci.Common.IOciResponse
    {
        ...
        public GovernanceInstanceConfiguration GovernanceInstanceConfiguration { get; set; }
