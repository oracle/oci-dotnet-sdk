...
namespace Oci.GenerativeaidataService
{
    ...
    public class GenerateEnrichmentJobClient : RegionalClientBase
    {
        ...
        /// <example>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/generativeaidata/GenerateEnrichmentJob.cs.html">here</a> to see an example of how to use GenerateEnrichmentJob API.</example>
