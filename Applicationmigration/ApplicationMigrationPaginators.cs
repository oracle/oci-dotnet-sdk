...
namespace Oci.ApplicationmigrationService
{
    ...
    public class ApplicationMigrationPaginators
    {
        ...
        public ApplicationMigrationPaginators(ApplicationMigrationClient client)
        {
            this.client = client;
        }
        ...
        public IEnumerable<ListMigrationsResponse> ListMigrationsResponseEnumerator(ListMigrationsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListMigrationsRequest, ListMigrationsResponse>(
                ...
                request => client.ListMigrations(request, retryConfiguration, cancellationToken).Result
            );
        }
        ...
        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListSourceApplications operation. This enumerable
        /// will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ListSourceApplicationsResponse> ListSourceApplicationsResponseEnumerator(ListSourceApplicationsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListSourceApplicationsRequest, ListSourceApplicationsResponse>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListSourceApplications(request, retryConfiguration, cancellationToken).Result
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the SourceApplicationSummary objects
        /// contained in responses from the ListSourceApplications operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<SourceApplicationSummary> ListSourceApplicationsRecordEnumerator(ListSourceApplicationsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListSourceApplicationsRequest, ListSourceApplicationsResponse, SourceApplicationSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
        ...
        /// <summary>
        /// Creates a new enumerable which will iterate over the SourceSummary objects
        ...
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<SourceSummary> ListSourcesRecordEnumerator(ListSourcesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListSourcesRequest, ListSourcesResponse, SourceSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
