...
namespace Oci.ResourcesearchService
{
    ...
    {
        private readonly ResourceSearchClient client;

        public ResourceSearchPaginators(ResourceSearchClient client)
        {
            this.client = client;
        }
        ...
        public IEnumerable<ListResourceTypesResponse> ListResourceTypesResponseEnumerator(ListResourceTypesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListResourceTypesRequest, ListResourceTypesResponse>(
                ...
                request => client.ListResourceTypes(request, retryConfiguration, cancellationToken).Result
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the ResourceType objects
        ...
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ResourceType> ListResourceTypesRecordEnumerator(ListResourceTypesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListResourceTypesRequest, ListResourceTypesResponse, ResourceType>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
