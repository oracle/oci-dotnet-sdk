...
namespace Oci.VnmonitoringService
{
    ...
    public class VnMonitoringPaginators
    {
        ...
        public VnMonitoringPaginators(VnMonitoringClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListPathAnalyzerTests operation. This enumerable
        ...
        public IEnumerable<ListPathAnalyzerTestsResponse> ListPathAnalyzerTestsResponseEnumerator(ListPathAnalyzerTestsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListPathAnalyzerTestsRequest, ListPathAnalyzerTestsResponse>(
                ...
                request => client.ListPathAnalyzerTests(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the PathAnalyzerTestSummary objects
        /// contained in responses from the ListPathAnalyzerTests operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<PathAnalyzerTestSummary> ListPathAnalyzerTestsRecordEnumerator(ListPathAnalyzerTestsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListPathAnalyzerTestsRequest, ListPathAnalyzerTestsResponse, PathAnalyzerTestSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListPathAnalyzerTests(request, retryConfiguration, cancellationToken),
                response => response.PathAnalyzerTestCollection.Items
            );
        }
        ...
        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListWorkRequestResults operation. This enumerable
        /// will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ListWorkRequestResultsResponse> ListWorkRequestResultsResponseEnumerator(ListWorkRequestResultsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListWorkRequestResultsRequest, ListWorkRequestResultsResponse>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListWorkRequestResults(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the WorkRequestResult objects
        /// contained in responses from the ListWorkRequestResults operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<WorkRequestResult> ListWorkRequestResultsRecordEnumerator(ListWorkRequestResultsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListWorkRequestResultsRequest, ListWorkRequestResultsResponse, WorkRequestResult>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListWorkRequestResults(request, retryConfiguration, cancellationToken),
                response => response.WorkRequestResultCollection.Items
            );
        }
