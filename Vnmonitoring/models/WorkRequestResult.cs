...
namespace Oci.VnmonitoringService.Models
{
    ...
    /// 
    /// </summary>
    [JsonConverter(typeof(WorkRequestResultModelConverter))]
    public class WorkRequestResult 
    {
        ...
        public enum ResultTypeEnum {
            [EnumMember(Value = "PATH_ANALYSIS")]
            PathAnalysis
        };
    ...
    public class WorkRequestResultModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(WorkRequestResult);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(WorkRequestResult);
            var discriminator = jsonObject["resultType"].Value<string>();
