...
{
    public class ListRoverClusterRoverBundleRequestsResponse : Oci.Common.IOciResponse
    {
        ...
        public RoverBundleRequestCollection RoverBundleRequestCollection { get; set; }
