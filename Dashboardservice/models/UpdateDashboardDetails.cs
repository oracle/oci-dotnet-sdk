...
namespace Oci.DashboardService.Models
{
    ...
    /// 
    /// </summary>
    [JsonConverter(typeof(UpdateDashboardDetailsModelConverter))]
    ...
    public class UpdateDashboardDetailsModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(UpdateDashboardDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(UpdateDashboardDetails);
            var discriminator = jsonObject["schemaVersion"].Value<string>();
            switch (discriminator)
            {
                case "V1":
                    obj = new UpdateV1DashboardDetails();
                    break;
            }
