...
namespace Oci.OceService
{
    ...
    public class OceInstancePaginators
    {
        ...
        public OceInstancePaginators(OceInstanceClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListOceInstances operation. This enumerable
        ...
        public IEnumerable<ListOceInstancesResponse> ListOceInstancesResponseEnumerator(ListOceInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListOceInstancesRequest, ListOceInstancesResponse>(
                ...
                request => client.ListOceInstances(request, retryConfiguration, cancellationToken).Result
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the OceInstanceSummary objects
        /// contained in responses from the ListOceInstances operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<OceInstanceSummary> ListOceInstancesRecordEnumerator(ListOceInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListOceInstancesRequest, ListOceInstancesResponse, OceInstanceSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
