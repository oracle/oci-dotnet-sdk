...
{
    public class GetSubnetCidrUtilizationResponse : Oci.Common.OciResponse
    {
        ...
        public IpInventoryCidrUtilizationCollection IpInventoryCidrUtilizationCollection { get; set; }
