...
{
    public class UpdateComputeImageCapabilitySchemaResponse : Oci.Common.IOciResponse
    {
        ...
        public ComputeImageCapabilitySchema ComputeImageCapabilitySchema { get; set; }
