...
namespace Oci.CoreService.Models
{
    ...
    [JsonConverter(typeof(InstanceConfigurationInstanceDetailsModelConverter))]
    ...
    public class InstanceConfigurationInstanceDetailsModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(InstanceConfigurationInstanceDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(InstanceConfigurationInstanceDetails);
