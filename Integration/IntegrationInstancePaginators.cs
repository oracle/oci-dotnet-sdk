...
namespace Oci.IntegrationService
{
    ...
    public class IntegrationInstancePaginators
    {
        ...
        public IntegrationInstancePaginators(IntegrationInstanceClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListIntegrationInstances operation. This enumerable
        ...
        public IEnumerable<ListIntegrationInstancesResponse> ListIntegrationInstancesResponseEnumerator(ListIntegrationInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListIntegrationInstancesRequest, ListIntegrationInstancesResponse>(
                ...
                request => client.ListIntegrationInstances(request, retryConfiguration, cancellationToken).Result
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the IntegrationInstanceSummary objects
        /// contained in responses from the ListIntegrationInstances operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<IntegrationInstanceSummary> ListIntegrationInstancesRecordEnumerator(ListIntegrationInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListIntegrationInstancesRequest, ListIntegrationInstancesResponse, IntegrationInstanceSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
