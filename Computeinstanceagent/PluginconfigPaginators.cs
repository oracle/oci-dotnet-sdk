...
namespace Oci.ComputeinstanceagentService
{
    ...
    /// to any list operations of Pluginconfig where multiple pages of data may be fetched.
    ...
    {
        private readonly PluginconfigClient client;

        public PluginconfigPaginators(PluginconfigClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListInstanceagentAvailablePlugins operation. This enumerable
        ...
        public IEnumerable<ListInstanceagentAvailablePluginsResponse> ListInstanceagentAvailablePluginsResponseEnumerator(ListInstanceagentAvailablePluginsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListInstanceagentAvailablePluginsRequest, ListInstanceagentAvailablePluginsResponse>(
