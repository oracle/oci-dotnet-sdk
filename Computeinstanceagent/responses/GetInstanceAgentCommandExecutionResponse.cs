...
{
    public class GetInstanceAgentCommandExecutionResponse : Oci.Common.IOciResponse
    {
        ...
        public InstanceAgentCommandExecution InstanceAgentCommandExecution { get; set; }
