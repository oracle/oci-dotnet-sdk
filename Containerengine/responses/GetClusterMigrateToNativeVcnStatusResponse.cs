...
{
    public class GetClusterMigrateToNativeVcnStatusResponse : Oci.Common.IOciResponse
    {
        ...
        public ClusterMigrateToNativeVcnStatus ClusterMigrateToNativeVcnStatus { get; set; }
