...
{
    public class DeploymentWalletExistsResponse : Oci.Common.IOciResponse
    {
        ...
        public DeploymentWalletExistsResponseDetails DeploymentWalletExistsResponseDetails { get; set; }
