...
{
    public class ListPipelineRunningProcessesResponse : Oci.Common.OciResponse
    {
        ...
        public PipelineRunningProcessCollection PipelineRunningProcessCollection { get; set; }
