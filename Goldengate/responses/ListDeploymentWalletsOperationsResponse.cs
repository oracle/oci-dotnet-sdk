...
{
    public class ListDeploymentWalletsOperationsResponse : Oci.Common.IOciResponse
    {
        ...
        public DeploymentWalletsOperationCollection DeploymentWalletsOperationCollection { get; set; }
