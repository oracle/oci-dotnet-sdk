...
namespace Oci.OpensearchService
{
    ...
    {
        private readonly OpensearchClusterClient client;

        public OpensearchClusterPaginators(OpensearchClusterClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListOpensearchClusters operation. This enumerable
        ...
        public IEnumerable<ListOpensearchClustersResponse> ListOpensearchClustersResponseEnumerator(ListOpensearchClustersRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListOpensearchClustersRequest, ListOpensearchClustersResponse>(
                ...
                request => client.ListOpensearchClusters(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the OpensearchClusterSummary objects
        /// contained in responses from the ListOpensearchClusters operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<OpensearchClusterSummary> ListOpensearchClustersRecordEnumerator(ListOpensearchClustersRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListOpensearchClustersRequest, ListOpensearchClustersResponse, OpensearchClusterSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListOpensearchClusters(request, retryConfiguration, cancellationToken),
                response => response.OpensearchClusterCollection.Items
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListOpensearchVersions operation. This enumerable
        /// will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ListOpensearchVersionsResponse> ListOpensearchVersionsResponseEnumerator(ListOpensearchVersionsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListOpensearchVersionsRequest, ListOpensearchVersionsResponse>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListOpensearchVersions(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the OpensearchVersionsSummary objects
        /// contained in responses from the ListOpensearchVersions operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<OpensearchVersionsSummary> ListOpensearchVersionsRecordEnumerator(ListOpensearchVersionsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListOpensearchVersionsRequest, ListOpensearchVersionsResponse, OpensearchVersionsSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListOpensearchVersions(request, retryConfiguration, cancellationToken),
                response => response.OpensearchVersionsCollection.Items
            );
        }
