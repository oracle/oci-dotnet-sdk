...
{
    public class ListOpensearchClusterBackupsResponse : Oci.Common.IOciResponse
    {
        ...
        public OpensearchClusterBackupCollection OpensearchClusterBackupCollection { get; set; }
