...
{
    public class ListOobManagementSavedSearchesResponse : Oci.Common.OciResponse
    {
        ...
        public ManagementSavedSearchCollection ManagementSavedSearchCollection { get; set; }
