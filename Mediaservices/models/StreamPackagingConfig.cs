...
namespace Oci.MediaservicesService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StreamPackagingConfigModelConverter))]
    ...
    public class StreamPackagingConfigModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(StreamPackagingConfig);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(StreamPackagingConfig);
            var discriminator = jsonObject["streamPackagingFormat"].Value<string>();
            switch (discriminator)
            {
                case "HLS":
                    obj = new HlsStreamPackagingConfig();
                    break;
                case "DASH":
                    obj = new DashStreamPackagingConfig();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under StreamPackagingConfig! Returning null value.");
            }
            return obj;
        }
    }
