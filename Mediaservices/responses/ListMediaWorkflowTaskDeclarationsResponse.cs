...
{
    public class ListMediaWorkflowTaskDeclarationsResponse : Oci.Common.IOciResponse
    {
        ...
        public MediaWorkflowTaskDeclarationCollection MediaWorkflowTaskDeclarationCollection { get; set; }
