...
{
    public class ListMediaWorkflowConfigurationsResponse : Oci.Common.IOciResponse
    {
        ...
        public MediaWorkflowConfigurationCollection MediaWorkflowConfigurationCollection { get; set; }
