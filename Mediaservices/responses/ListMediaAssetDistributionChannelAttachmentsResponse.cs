...
{
    public class ListMediaAssetDistributionChannelAttachmentsResponse : Oci.Common.IOciResponse
    {
        ...
        public MediaAssetDistributionChannelAttachmentCollection MediaAssetDistributionChannelAttachmentCollection { get; set; }
