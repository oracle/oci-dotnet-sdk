...
{
    public class ListStreamDistributionChannelsResponse : Oci.Common.IOciResponse
    {
        ...
        public StreamDistributionChannelCollection StreamDistributionChannelCollection { get; set; }
