...
{
    public class GetMediaAssetDistributionChannelAttachmentResponse : Oci.Common.IOciResponse
    {
        ...
        public MediaAssetDistributionChannelAttachment MediaAssetDistributionChannelAttachment { get; set; }
