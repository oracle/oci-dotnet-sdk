...
{
    public class UpdateLogAnalyticsObjectCollectionRuleResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsObjectCollectionRule LogAnalyticsObjectCollectionRule { get; set; }
