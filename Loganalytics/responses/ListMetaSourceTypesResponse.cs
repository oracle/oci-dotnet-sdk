...
{
    public class ListMetaSourceTypesResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsMetaSourceTypeCollection LogAnalyticsMetaSourceTypeCollection { get; set; }
