...
{
    public class ListSourceExtendedFieldDefinitionsResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsSourceExtendedFieldDefinitionCollection LogAnalyticsSourceExtendedFieldDefinitionCollection { get; set; }
