...
{
    public class ListLogAnalyticsLogGroupsResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsLogGroupSummaryCollection LogAnalyticsLogGroupSummaryCollection { get; set; }
