...
{
    public class ListResourceCategoriesResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsResourceCategoryCollection LogAnalyticsResourceCategoryCollection { get; set; }
