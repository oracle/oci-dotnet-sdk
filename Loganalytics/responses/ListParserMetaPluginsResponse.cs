...
{
    public class ListParserMetaPluginsResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsParserMetaPluginCollection LogAnalyticsParserMetaPluginCollection { get; set; }
