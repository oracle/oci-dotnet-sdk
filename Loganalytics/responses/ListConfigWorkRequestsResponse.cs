...
{
    public class ListConfigWorkRequestsResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsConfigWorkRequestCollection LogAnalyticsConfigWorkRequestCollection { get; set; }
