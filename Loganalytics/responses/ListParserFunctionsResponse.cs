...
{
    public class ListParserFunctionsResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsParserFunctionCollection LogAnalyticsParserFunctionCollection { get; set; }
