...
{
    public class ListLogAnalyticsEntityTypesResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsEntityTypeCollection LogAnalyticsEntityTypeCollection { get; set; }
