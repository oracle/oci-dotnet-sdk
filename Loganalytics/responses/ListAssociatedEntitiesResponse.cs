...
{
    public class ListAssociatedEntitiesResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsAssociatedEntityCollection LogAnalyticsAssociatedEntityCollection { get; set; }
