...
{
    public class ValidateAssociationParametersResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsAssociationParameterCollection LogAnalyticsAssociationParameterCollection { get; set; }
