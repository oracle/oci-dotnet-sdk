...
{
    public class ListSourceLabelOperatorsResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsLabelOperatorCollection LogAnalyticsLabelOperatorCollection { get; set; }
