...
{
    public class ListSourceMetaFunctionsResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsMetaFunctionCollection LogAnalyticsMetaFunctionCollection { get; set; }
