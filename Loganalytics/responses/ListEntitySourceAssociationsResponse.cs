...
{
    public class ListEntitySourceAssociationsResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsAssociationCollection LogAnalyticsAssociationCollection { get; set; }
