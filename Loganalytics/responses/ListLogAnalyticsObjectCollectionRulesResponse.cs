...
{
    public class ListLogAnalyticsObjectCollectionRulesResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsObjectCollectionRuleCollection LogAnalyticsObjectCollectionRuleCollection { get; set; }
