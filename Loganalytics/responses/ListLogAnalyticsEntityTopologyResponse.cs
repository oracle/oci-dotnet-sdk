...
{
    public class ListLogAnalyticsEntityTopologyResponse : Oci.Common.IOciResponse
    {
        ...
        public LogAnalyticsEntityTopologyCollection LogAnalyticsEntityTopologyCollection { get; set; }
