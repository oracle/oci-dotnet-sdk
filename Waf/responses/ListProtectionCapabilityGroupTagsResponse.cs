...
{
    public class ListProtectionCapabilityGroupTagsResponse : Oci.Common.IOciResponse
    {
        ...
        public ProtectionCapabilityGroupTagCollection ProtectionCapabilityGroupTagCollection { get; set; }
