...
namespace Oci.ContainerinstancesService
{
    ...
    public class ContainerInstancePaginators
    {
        ...
        public ContainerInstancePaginators(ContainerInstanceClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListContainerInstanceShapes operation. This enumerable
        ...
        public IEnumerable<ListContainerInstanceShapesResponse> ListContainerInstanceShapesResponseEnumerator(ListContainerInstanceShapesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListContainerInstanceShapesRequest, ListContainerInstanceShapesResponse>(
                ...
                request => client.ListContainerInstanceShapes(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the ContainerInstanceShapeSummary objects
        /// contained in responses from the ListContainerInstanceShapes operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ContainerInstanceShapeSummary> ListContainerInstanceShapesRecordEnumerator(ListContainerInstanceShapesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListContainerInstanceShapesRequest, ListContainerInstanceShapesResponse, ContainerInstanceShapeSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListContainerInstanceShapes(request, retryConfiguration, cancellationToken),
                response => response.ContainerInstanceShapeCollection.Items
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListContainerInstances operation. This enumerable
        /// will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ListContainerInstancesResponse> ListContainerInstancesResponseEnumerator(ListContainerInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListContainerInstancesRequest, ListContainerInstancesResponse>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListContainerInstances(request, retryConfiguration, cancellationToken)
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the ContainerInstanceSummary objects
        /// contained in responses from the ListContainerInstances operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ContainerInstanceSummary> ListContainerInstancesRecordEnumerator(ListContainerInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListContainerInstancesRequest, ListContainerInstancesResponse, ContainerInstanceSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListContainerInstances(request, retryConfiguration, cancellationToken),
                response => response.ContainerInstanceCollection.Items
            );
        }
