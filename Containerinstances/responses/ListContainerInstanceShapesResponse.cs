...
{
    public class ListContainerInstanceShapesResponse : Oci.Common.IOciResponse
    {
        ...
        public ContainerInstanceShapeCollection ContainerInstanceShapeCollection { get; set; }
