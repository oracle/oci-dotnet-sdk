...
{
    public class ListEnforcedGovernanceRulesResponse : Oci.Common.IOciResponse
    {
        ...
        public EnforcedGovernanceRuleCollection EnforcedGovernanceRuleCollection { get; set; }
