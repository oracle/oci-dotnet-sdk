...
{
    public class FindRunbookExportDependencyResponse : Oci.Common.OciResponse
    {
        ...
        public RunbookExportDependencyCollection RunbookExportDependencyCollection { get; set; }
