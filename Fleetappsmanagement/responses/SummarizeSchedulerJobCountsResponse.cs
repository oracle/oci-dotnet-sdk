...
{
    public class SummarizeSchedulerJobCountsResponse : Oci.Common.OciResponse
    {
        ...
        public SchedulerJobAggregationCollection SchedulerJobAggregationCollection { get; set; }
