...
{
    public class SummarizeManagedEntityCountsResponse : Oci.Common.OciResponse
    {
        ...
        public ManagedEntityAggregationCollection ManagedEntityAggregationCollection { get; set; }
