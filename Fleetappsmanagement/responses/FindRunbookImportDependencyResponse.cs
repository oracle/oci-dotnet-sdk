...
{
    public class FindRunbookImportDependencyResponse : Oci.Common.OciResponse
    {
        ...
        public RunbookImportDependencyCollection RunbookImportDependencyCollection { get; set; }
