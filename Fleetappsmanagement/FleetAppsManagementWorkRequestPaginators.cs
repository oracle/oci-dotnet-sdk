...
namespace Oci.FleetappsmanagementService
{
    ...
    {
        private readonly FleetAppsManagementWorkRequestClient client;

        public FleetAppsManagementWorkRequestPaginators(FleetAppsManagementWorkRequestClient client)
        {
            this.client = client;
        }
