...
namespace Oci.FunctionsService
{
    ...
    public class FunctionsInvokeClient : ClientBase
    {
        ...
        /// <example>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/8.1.0/functions/InvokeFunction.cs.html">here</a> to see an example of how to use InvokeFunction API.</example>
