...
{
    public class UpdateFleetAdvancedFeatureConfigurationResponse : Oci.Common.IOciResponse
    {
        ...
        public FleetAdvancedFeatureConfiguration FleetAdvancedFeatureConfiguration { get; set; }
