...
{
    public class ListAssignedSubscriptionLineItemsResponse : Oci.Common.IOciResponse
    {
        ...
        public AssignedSubscriptionLineItemCollection AssignedSubscriptionLineItemCollection { get; set; }
